    ...
    return {
        ...
        link: function($scope, elem, attrs) {
            ...
            $scope.selectResult = function(result) {
                ...
                $scope.searchStr = $scope.lastSearchTerm = result.title + ', ' + result.description;
